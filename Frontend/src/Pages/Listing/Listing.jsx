...
function Listing() {
    const { language, currentPage, setCurrentPage, tables, watches, fashion,
        // offers, fetchCart, setCart,user_id,
        Loader, products, windowWidth, filters, setFilters, handleAddTowishlist } = useContext(MyContext);
