...
function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await http.post('/login', { email: cleanEmail, password: cleanPassword })
  ...
  return (
    <div
      className="login"
      style={{ height: '100%', width: '100vw', position: 'fixed', top: 0, left: 0 }}
    >
      <div className="container" style={{ height: '100%' }}>
        <div className="row justify-content-center px-md-5 px-2" style={{ height: '100%' }}>
          <div
            className="col-md-6 col-12 d-flex flex-column justify-content-center align-items-center"
            style={{ height: '100%' }}
          >
