...
function Login() {
  ...
  const [email, setEmail] = useState(() => localStorage.getItem('wz_remember_email') || '')
  const [password, setPassword] = useState('')
  const [showPw, setShowPw] = useState(false)
  const [remember, setRemember] = useState(() => !!localStorage.getItem('wz_remember_email'))
  ...
  const handleSubmit = useCallback(
    ...
    [email, password, remember, loading, from, login, navigate, validate, isRTL],
  )
    ...
    <AuthShell title={t('Welcome back', 'مرحباً بعودتك')} subtitle={t('Sign in to your account', 'سجّل دخولك')}>
      ...
      <form className="wz-auth-form" onSubmit={handleSubmit} noValidate>
        ...
        <div className="wz-auth-row">
          ...
          <Link to="/forgot-password" className="wz-auth-link-muted">
      ...
      <p className="wz-auth-foot">
        ...
        <Link to="/register" className="wz-auth-link-gold">
