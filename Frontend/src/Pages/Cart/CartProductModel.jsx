...
function CartProductModel({ open, onClose, product, language, quantity }) {
  ...
  const renderDetailquantity = (labelEn, labelAr, value) => (
    <div className="col-6 d-flex align-items-center">
      <p
        className="fw-bold m-0 p-1  border border-dark border-1 rounded-3 color-most-used"
          ...
          <div className="col-7 product-info">
            ...
            <div className="row align-items-center">
              ...
              {product?.features?.length > 0 &&
                renderDetail('Features', 'الميزات', product.features.join(', '), 'small', 'col-6')}
              ...
              {product?.band_color &&
                renderColorDetail('Band Color', 'لون السوار', product.band_color, 'small', 'col-6')}
              ...
              <div className="mt-3 action-buttons">
                <Link to={`/product/${product.id}`}>
                  <button className={`${language === 'ar' ? 'ms-2' : 'me-2'} btn btn-dark`}>
