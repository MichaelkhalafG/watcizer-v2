...
function Home() {
    const { products, tables, language, windowWidth, offers, sideBanners, bottomBanners,  HomeBannersPc, HomeBannersMob} = useContext(MyContext);
    ...
    return (
        <div className="home px-md-5 pb-md-0 pb-5 container-fluid" >
            {windowWidth <= 768 ? <div className='py-2'><CategoryNavPhone /></div> : null}
