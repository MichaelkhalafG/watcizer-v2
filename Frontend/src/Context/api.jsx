...
export const fetchBanners = async (setSideBanners, setBottomBanners, setHomeBannersPc, setHomeBannersMob) => {
    try {
        ...
        const [side, bottom, home] = responses.map((res) => (res.status === "fulfilled" ? res.value.data : []));
