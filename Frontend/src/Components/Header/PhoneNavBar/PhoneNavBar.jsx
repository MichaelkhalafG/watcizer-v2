...
function PhoneNavBar() {
  ...
  return (
    <div className="phone-nav-bar d-md-none d-block bg-light position-relative position-fixed text-light p-3 px-0 pb-0">
      <div
        className="rounded-circle align-items-center justify-content-center d-flex flex-column text-center bg-dark position-absolute"
        style={{
          top: '-8px',
          left: '50%',
      ...
      >
        <Link
          to="/cart"
          className="text-light d-flex align-items-center justify-content-center position-relative p-2"
        >
