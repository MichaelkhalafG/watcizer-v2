                            ...
                            .map((subtype) => (
                                ...
                                >
                                    ...
                                    {hoveredSubtype === subtype.id && (
                                        <div className="sub-menu position-absolute start-100 top-0 p-3 border rounded bg-white" style={{width:"300px"}} >
                                            {tables.brands &&
                                                tables.brands
                                                    .filter((brand) => products.some((product) => product.brand_id === brand.id && product.sub_type_id === subtype.id))
                                                    .map((brand) => (
                                                        <Link
                                                            key={brand.id}
