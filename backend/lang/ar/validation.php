...
return [
    ...
    */
    ...
    'exists' => 'حقل المحدد من :attribute غير صالح.',
    ...
    */
    ...
    'attributes' => [
        'name'                  => 'الاسم',
        'brand_name.ar'         => 'اسم العلامة التجارية ar',
        'brand_name.en'         => 'اسم العلامة التجارية en',
        'grade_name.ar'         => 'اسم الدرجة ar',
        'grade_name.en'         => 'اسم الدرجة en',
        'description.ar'        => 'وصف الدرجة ar',
        'description.en'        => 'وصف الدرجة en',
        'sub_type_name.ar'      => 'اسم النوع الفرعي ar',
        'sub_type_name.en'      => 'اسم النوع الفرعي en',
        'category_type_name.ar' => 'اسم نوع الفئة ar',
        'category_type_name.en' => 'اسم نوع الفئة en',
        'category_name.ar'      => 'اسم الفئة ar',
        'category_name.en'      => 'اسم الفئة en',
        'category_image'        => 'صورة الفئة',
        'color_value'           => 'اللون',
        'color_name.ar'         => 'اسم اللون ar',
        'color_name.en'         => 'اسم اللون en',
        'closure_type_name.ar'  => 'اسم نوع الإغلاق ar',
        'closure_type_name.en'  => 'اسم نوع الإغلاق en',
        'display_type_name.ar'  => 'اسم نوع العرض ar',
        'display_type_name.en'  => 'اسم نوع العرض en',
        'size_type_name.ar'     => 'اسم وحدة الحجم ar',
        'size_type_name.en'     => 'اسم وحدة الحجم en',
        'shape_name.ar'         => 'اسم الشكل ar',
        'shape_name.en'         => 'اسم الشكل en',
        'material_name.ar'      => 'اسم المادة  ar',
        'material_name.en'      => 'اسم المادة  en',
        'feature_name.ar'       => 'اسم الميزة  ar',
        'feature_name.en'       => 'اسم الميزة  en',
        'gender_name.ar'        => 'اسم نوع الجنس  ar',
        'gender_name.en'        => 'اسم نوع الجنس  en',
        'movement_type_name.ar' => 'اسم نوع الحركة  ar',
        'movement_type_name.en' => 'اسم نوع الحركة  en',
        'category_id'                   => 'الفئة',
        'category_type_id'              => 'نوع الفئة',
        'brand_id'                      => 'العلامة تجارية',
        'grade_id'                      => 'الدرجة',
        ...
        'band_material_id'              => 'مادة حزام الساعة',
        'watch_movement_id'             => 'نوع حركة الساعة',
        'stock'                         => 'المخزون',
        ...
        'interchangeable_dial'          => 'القرص قابل للتبديل',
        'interchangeable_strap'         => 'الحزام قابل للتبديل',
        'active'                        => 'هل هو نشط',
        'wa_code'                       => 'wa كود',
        'rate'                          => 'تقييم النجوم',
        'watch_box'                     => 'هل يوجد صندوق للساعة؟',
        'product_title.ar'              => 'عنوان المنتج ar',
        'product_title.en'              => 'عنوان المنتج en',
        'short_description.ar'          => 'وصف مختصر ar',
        'short_description.en'          => 'وصف مختصر en',
        'long_description.ar'           => 'وصف طويل ar',
        'long_description.en'           => 'وصف طويل en',
        'gender.ar'                     => 'الجنس ar',
        'gender.en'                     => 'الجنس en',
        'model_name.ar'                 => 'اسم الموديل ar',
        'model_name.en'                 => 'اسم الموديل en',
        'country.ar'                    => 'بلد الصنع ar',
        'country.en'                    => 'بلد الصنع en',
        'stone.ar'                      => 'نوع الحجر ar',
        'stone.en'                      => 'نوع الحجر en',
        'sku_unique'                    => 'رقم تعريف المنتج فريد',
        ...
        'offer_name.ar'                 => 'اسم العرض ar',
        'offer_name.en'                 => 'اسم العرض en',
        'stock.en'                      => 'المخزون',
        'city_name.ar'                  => 'اسم مدينة الشحن ar',
        'city_name.en'                  => 'اسم مدينة الشحن en',
        'title.ar'                      => 'عنوان المدونة ar',
        'title.en'                      => 'عنوان المدونة en',
        'text.ar'                       => 'نص المدونة ar',
        'text.en'                       => 'نص المدونة en',
