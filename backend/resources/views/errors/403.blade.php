...
<head>
    ...
    <style>
        ...
        top: -50px;
        transform: scale(0.8);
        background: url('{{ asset('DashAssets/img/errors/HauntedHouseBackground.png') }}');
...
<body>
    ...
    <div class="bat">
        <img class="wing leftwing"
            src="{{ asset('DashAssets/img/errors/bat-wing.png') }}">
        <img class="body"
            src="{{ asset('DashAssets/img/errors/bat-body.png') }}" alt="bat">
    ...
    <img class="foregroundimg" src="{{ asset('DashAssets/img/errors/HauntedHouseForeground.png') }}" alt="haunted house">
...
<head>
    ...
    <style>
        ...
        .four_zero_four_bg{
            ...
            background-image: url({{ asset('DashAssets/img/errors/dribbble_1.gif') }});
            height: 400px;
            background-position: center;
        }
  ...
  <body>
    ...
    <section class="page_404">
      <div class="container">
          ...
          <h3 class="h2">
            To enter our circle, you need a visa.
          </h3>
