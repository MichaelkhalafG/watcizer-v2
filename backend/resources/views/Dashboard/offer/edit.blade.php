 ...
 @section('content')
     ...
     <div class="row">
         <div class="pagetitle col-6">
             <h1>{{ trans('offer.edit_offer') }}</h1>
             <nav>
                 <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ trans('sidebar.dashboard') }}</a></li>
                    <li class="breadcrumb-item">{{ trans('sidebar.offer') }}</li>
                     <li class="breadcrumb-item active">{{ trans('offer.edit_offer') }}</li>
                 </ol>
             </nav>
         </div><!-- End Page Title -->
     </div>
     ...
     <section class="section">
         <div class="row">
             <div class="col-lg-12">
                 ...
                 <div class="card">
                     <div class="card-body">
                         <h5 class="card-title">{{ trans('offer.edit_offer') }}</h5>

                         <form action="{{ route('offer.update' , $offer->id) }}" class="row g-3" method="POST" enctype="multipart/form-data">
                             @csrf
                             @method('PUT')

                                <div class="col-6">
                                    <label for="offer_name[ar]" class="form-label">{{ trans('offer.offer_name') }} ar</label>
                                    <input type="text" class="form-control" name="offer_name[ar]" id="offer_name[ar]" value="{{ old('offer_name.ar' , $offer->translate('ar')->offer_name) }}">
                                    @error('offer_name.ar')
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control" name="offer_name[en]" id="offer_name[en]" value="{{ old('offer_name.en' , $offer->translate('en')->offer_name) }}">
                                    @error('offer_name.en')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-8">
                                    ...
                                    <select class="form-select select2" name="main_product_id" id="main_product_id">
                                        ...
                                        @foreach ($product as $item)
                                            <option value="{{ $item->id }}" @selected(old('main_product_id' , $offer->main_product_id) == $item->id)>{{ $item->product_title . ' - (' . $item->wa_code . ')' }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-4">
                                    ...
                                    <select name="in_season" id="in_season" class="form-select">
                                        ...
                                        <option value="yes" @selected(old('in_season' , $offer->in_season) == 'yes')>{{ trans('offer.yes') }}</option>
                                        <option value="no" @selected(old('in_season' , $offer->in_season) == 'no')>{{ trans('offer.no') }}</option>
                                    </select>
                                    @error('in_season')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="col-12">
                                    ...
                                    <ul id="selected-products-list" class="list-group mt-3">
                                        @if (old('gift_product_ids' , $offer->gift_product_ids))
                                            @foreach (old('gift_product_ids' , $offer->gift_product_ids) as $id)
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control" name="wa_code" data-name="wa_code" id="wa_code" value="{{ old('wa_code' , $offer->translate('ar')->short_description) }}">
                                    @error('wa_code')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <select class="form-select select2" name="category_type_id" id="category_type_id">
                                        ...
                                        @foreach ($category_type as $item)
                                            <option value="{{ $item->id }}" @selected(old('category_type_id' , $offer->category_type_id) == $item->id)>{{ $item->category_type_name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-4">
                                    ...
                                    <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" class="form-control" name="selling_price" id="selling_price" value="{{ old('selling_price' , $offer->selling_price) }}">
                                    @error('selling_price')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-4">
                                    ...
                                    <input oninput="this.value=this.value.replace(/[^0-9.]/g,'');" class="form-control" name="sale_price_after_discount" id="sale_price_after_discount" value="{{ old('sale_price_after_discount' , $offer->sale_price_after_discount) }}">
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="number" min="0" class="form-control" name="stock" id="stock" value="{{ old('stock' , $offer->stock) }}">
                                    @error('stock')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <textarea class="form-control" name="short_description[ar]" id="short_description[ar]" rows="1">{{ old('short_description.ar' , $offer->translate('ar')->short_description) }}</textarea>
                                ...
                                <div class="col-6">
                                    ...
                                    <textarea class="form-control" name="short_description[en]" id="short_description[en]" rows="1">{{ old('short_description.en' , $offer->translate('ar')->short_description) }}</textarea>
                                ...
                                <div class="col-6">
                                    ...
                                    <textarea class="form-control" name="long_description[ar]" id="long_description[ar]" rows="1">{{ old('long_description.ar' , $offer->translate('ar')->short_description) }}</textarea>
                                ...
                                <div class="col-6">
                                    ...
                                    <textarea class="form-control" name="long_description[en]" id="long_description[en]" rows="1">{{ old('long_description.en' , $offer->translate('ar')->short_description) }}</textarea>
