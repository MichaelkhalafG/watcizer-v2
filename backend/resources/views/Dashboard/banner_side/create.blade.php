...
@section('title-head')
    {{ trans('banner_side.add') }}
@endsection

@section('content')
    <div class="row">
        <div class="pagetitle col-6">
            <h1>{{ trans('banner_side.add') }}</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ trans('sidebar.dashboard') }}</a></li>
                    <li class="breadcrumb-item">{{ trans('sidebar.banner_side') }}</li>
                    <li class="breadcrumb-item active">{{ trans('banner_side.add') }}</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
    </div>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">{{ trans('banner_side.add') }}</h5>

                        <form action="{{ route('banner_side.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
