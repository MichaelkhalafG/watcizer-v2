...
@section('title-head')
    {{ trans('product_image.add') }}
@endsection

@section('content')
    <div class="row">
        <div class="pagetitle col-6">
            <h1>{{ trans('product_image.add') }}</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ trans('sidebar.dashboard') }}</a></li>
                    <li class="breadcrumb-item">{{ trans('sidebar.product_image') }}</li>
                    <li class="breadcrumb-item active">{{ trans('product_image.add') }}</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
    </div>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">{{ trans('product_image.add') }}</h5>
