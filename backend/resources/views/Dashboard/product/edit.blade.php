...
<div class="col-3">
    ...
    <input class="form-control" name="low_stock_threshold" oninput="this.value=this.value.replace(/[^0-9]/g,'')"
...
<div class="col-12">
    ...
    <input type="text" class="form-control" name="seo_title" value="{{ old('seo_title', $product->seo_title) }}" maxlength="60">
    @error('seo_title')<p class="err">{{ $message }}</p>@enderror
</div>
<div class="col-12">
    <label class="form-label">{{ trans('product.seo_slug') }}</label>
    <input type="text" class="form-control" name="seo_slug" value="{{ old('seo_slug', $product->seo_slug) }}">
    @error('seo_slug')<p class="err">{{ $message }}</p>@enderror
</div>
<div class="col-12">
    <label class="form-label">{{ trans('product.seo_meta_description') }}</label>
    <textarea class="form-control" name="seo_meta_description" rows="2" maxlength="160">{{ old('seo_meta_description', $product->seo_meta_description) }}</textarea>
