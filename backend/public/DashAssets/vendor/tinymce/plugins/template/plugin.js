...
(function () {
    ...
    const getSelectedContentClasses = option(
    ...
    const htmlEscape = (html) =>
        html.replace(/["'<>&]/g, (match) =>
            get(entitiesAttr, match).getOr(match),
        );
    ...
    const getPreviewContent = (editor, html) => {
        ...
        if (html.indexOf("<html>") === -1) {
            ...
            const contentStyle =
                (_a = getContentStyle(editor)) !== null && _a !== void 0
                    ? _a
                    : "";
        ...
        return replaceTemplateValues(
            previewHtml,
            getPreviewReplaceValues(editor),
        );
    };
