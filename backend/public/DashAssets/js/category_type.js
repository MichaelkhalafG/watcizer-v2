$(document).ready(function () {
    /// For open modal ///
    $(document).on("click", "#openAddCategoryType", function (e) {
        var url = $("#urlAddCategoryType").val();
    ...
    /// For request form ///
    var clickCount = 0;
    $(document).on("submit", "#addCategoryTypeForm", function (e) {
        e.preventDefault();
    ...
    $(document).on("submit", "#addCategoryTypeForm", function (e) {
        ...
        $.ajax({
            url: "http://127.0.0.1:4000/ar/admin/category_type/reload",
            type: "get",
            success: function (data) {
