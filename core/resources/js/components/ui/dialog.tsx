...
>(({ className, children, title, description, ...props }, ref) => {
    // A block body rather than an implicit return, because the close button's accessible name is
    // translated and a hook cannot run inside an expression-bodied arrow.
    const t = useT();
