    ...
    public function mayConvert(int $productId): array
    {
        ...
        return [
            ...
            'reason' => ManageText::t(
                ...
                'لا يمكن تحويل هذا المنتج إلى مقاسات الآن: مخزونه ما زال يُخصم من مكان آخر، والتحويل سيجعل الرقمين يختلفان دون أن ينتبه أحد. لو احتجت منتجًا بمقاسات، أنشئه بمقاسات من البداية.',
            ),
        ];
    }
